...
import { 
  ...
  Search, Zap, FileSearch, ArrowRight, Check, Star
} from "lucide-react";
      ...
      <main>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Button size="lg" asChild>
                  <Link to="/demarrer-projet">
                    Démarrer un projet <ArrowRight size={18} className="ml-2" />
                  </Link>
                </Button>
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex flex-col sm:flex-row items-center justify-between gap-6 p-8 rounded-3xl bg-gradient-to-r from-primary/10 via-accent/5 to-primary/10 border border-primary/20"
            >
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-display font-bold mb-4">Besoin d'un service sur-mesure ?</h2>
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Nous créons des solutions personnalisées adaptées à vos besoins spécifiques. Discutons de votre projet !
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Button size="lg" asChild>
                  <Link to="/demarrer-projet">Démarrer mon projet <ArrowRight size={18} className="ml-2" /></Link>
                </Button>
                <Button size="lg" variant="outline" asChild>
                  <a href="https://wa.me/2250504292778" target="_blank" rel="noopener noreferrer">Discuter sur WhatsApp</a>
                </Button>
              </div>
            </motion.div>
          </div>
...
const ServiceCard = ({ service }: { service: typeof services[0] }) => (
  <motion.div variants={itemVariants} className="group relative">
    <Link to={service.link} className="block h-full">
      <div className="h-full p-6 rounded-2xl bg-card border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-300 relative overflow-hidden">
